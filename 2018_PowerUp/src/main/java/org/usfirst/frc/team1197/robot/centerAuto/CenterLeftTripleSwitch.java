...
public class CenterLeftTripleSwitch {
	...
	public CenterLeftTripleSwitch(DriveHardware drive, TorBantorShooarm shooArm) {
		this.drive = drive;
		this.shooArm = shooArm;
		Move1 = new LinearTrajectory(drive, 0.6, shooArm, 1.0);
		Move2 = new PivotTrajectory(drive, -26, shooArm, 1.5);
		Move3 = new PivotTrajectory(drive, 21, shooArm, 1.5);
		//goes forward to intake and goes back for the same time with a PID here
		Move4 = new LinearTrajectory(drive, -0.6, shooArm, 1);
		Move5 = new PivotTrajectory(drive, -19, shooArm, 1.5);
		Move6 = new PivotTrajectory(drive, -38, shooArm, 1.5);//positive
		Move7 = new LinearTrajectory(drive, 1.0, shooArm, 1.5);//positive
		Move8 = new PivotTrajectory(drive, 78, shooArm, 2.0);//negative
		...
		Move11 = new PivotTrajectory(drive, -34, shooArm, 0.5);//positive
