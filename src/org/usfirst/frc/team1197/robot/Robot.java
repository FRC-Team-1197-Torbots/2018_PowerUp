...
public class Robot extends SampleRobot {
	...
	*/
    ...
    public Robot() {
    	...
    	drive = new TorDrive(player1, autoBox); // TorDrive object used to enable the drive of the robot
    	...
    	shooArm = new TorBantorShooarm(player2, armTalon1, armTalon2, shootakeTalon1, shootakeTalon2, 
    			...
    			holdAngle, Pusher, scaleBackwardsAngle); // TorBantorShooarm object used to enable the arm control + intake/shoot control of the robot
    }
